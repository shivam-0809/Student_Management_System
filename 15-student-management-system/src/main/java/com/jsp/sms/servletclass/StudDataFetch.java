...
@WebServlet(value = "/StudDatafetch")
public class StudDataFetch extends HttpServlet{
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		String DataFetch = req.getParameter("StudDatafetch");
		int Fetch=Integer.parseInt(DataFetch);

//		Student studentData = new Student();
		Student_Controller studFetch = new Student_Controller();

		Student student = studFetch.ReadMyInfo(Fetch);
